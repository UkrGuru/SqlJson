...
public class DbServiceTests
{
    ...
    public async Task CanExecAsync_Null()
    {
        ...
        Assert.Null(await _db.ExecAsync<string?>("ProcVar", SqlChars.Null));
        Assert.Null(await _db.ExecAsync<string?>("ProcVar", SqlString.Null));

        Assert.Null(await _db.ExecAsync<string?>("ProcXml", SqlXml.Null));
    }
    ...
    public async Task CanExecAsync_SqlBinary(byte[] bytes)
    {
        ...
        Assert.Equal(sqlValue.Value, (await _db.ExecAsync<SqlBinary>("ProcVarBin", sqlValue)).Value);
    }
    ...
    public async Task CanExecAsync_SqlBytes(byte[] bytes)
    {
        ...
        Assert.Equal(sqlValue.Value, (await _db.ExecAsync<SqlBytes>("ProcVarBin", sqlValue))!.Value);
    }
    ...
    public async Task CanExecAsync_SqlChars(char[] chars)
    {
        ...
        Assert.Equal(sqlValue.Value, (await _db.ExecAsync<SqlChars>("ProcVarChar", sqlValue))!.Value);
    }
